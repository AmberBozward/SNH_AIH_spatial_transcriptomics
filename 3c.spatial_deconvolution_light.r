...
png("3c_spatial_deconvolution_light/light_integrated_deonvolution_HEP_spatial.png", height = 6000, width = 4000)
print(plot)
dev.off()
...
png("3c_spatial_deconvolution_light/light_integrated_deonvolution_Kuppher_spatial.png", height = 6000, width = 4000)
print(plot)
dev.off()
...
liver_st = readRDS(file = "liver_integrated_light_decon.rds")
...
# plot spatially
plot = SpatialPlot(object = liver_st, features = top.clusters, ncol = 9, crop = TRUE, image.alpha = 0, stroke = NA, pt.size.factor = 6)
png("3c_spatial_deconvolution_light/light_integrated_deonvolution_variable_features_spatial.png", height = 6000, width = 4000)
print(plot)
dev.off()

# plot change
plot = VlnPlot(liver_st, group.by = "seurat_clusters", features = top.clusters, pt.size = 0,ncol = 2)
png("3c_spatial_deconvolution_light/light_integrated_deonvolution_variable_features_violin.png", height = 1500, width = 1500)
print(plot)
dev.off()
...
plot = SpatialFeaturePlot(liver_st, features = c("CYP2E1", "PLA2G2A", "FABP1", "MAT1A","ADIRF","IGFBP1","APOC3","MARCO","CTSD","GSTA1","C3","CLDN10","ADGRF5","HSPB1","CD7","MZB1","SNCG","CD37","SLC25A6","GPX3","C7","RPL13A","ALOX5AP","ZWINT","SH3BGRL"), image.alpha = 0, stroke = NA, pt.size.factor = 6)
png("3c_spatial_deconvolution_light/light_integrated_cell_type_markers_spatial.png", height = 8000, width = 3000)
print(plot)
dev.off()


plot = SpatialFeaturePlot(liver_st, features = c("CLDN10", "ADGRF5", "SNCG", "SH3BGRL", "MARCO", "CTSD", "CD37", "SLC25A6"), image.alpha = 0, stroke = NA, pt.size.factor = 6)
png("3c_spatial_deconvolution_light/light_integrated_cell_type_markers_CC_EC_MP_spatial.png", height = 3000, width = 2500)
print(plot)
dev.off()


plot = SpatialFeaturePlot(liver_st, features = c("CYP2E1", "PLA2G2A", "FABP1", "MAT1A", "ADIRF", "IGFBP1", "APOC3", "GSTA1", "C3", "HSPB1"), image.alpha = 0, stroke = NA, pt.size.factor = 6)
png("3c_spatial_deconvolution_light/light_integrated_cell_type_markers_Hep_spatial.png", height = 3000, width = 2500)
print(plot)
dev.off()


plot = SpatialFeaturePlot(liver_st, features = c("GPX3", "C7", "CD7", "MZB1", "RPL13A", "ALOX5AP", "ZWINT"), image.alpha = 0, stroke = NA, pt.size.factor = 6)
png("3c_spatial_deconvolution_light/light_integrated_cell_type_markers_HSC_LP_spatial.png", height = 3000, width = 2500)
print(plot)
dev.off()
