...
## load
liver_st = readRDS(file = "liver_integrated_light_psudo_decon.rds")
...
png("3e.pseudobulk_linneages_deconvolution/similarity_matrix.png", height = 750, width = 750)
print(plot)
dev.off()
...
png("3e.pseudobulk_linneages_deconvolution/Light_Pseudo_Decon_proportions.png", height = 750, width = 750)
print(plot)
dev.off()

plot = plot_deconvolute(deconvoluted = decon, scale = TRUE, labels = TRUE)
png("3e.pseudobulk_linneages_deconvolution/Light_Pseudo_Decon_methods.png", height = 750, width = 750)
print(plot)
dev.off()
...
# save RDS
saveRDS(st_pseudo_em, file = "3e.pseudobulk_linneages_deconvolution/pseudo_st.rds")
saveRDS(sc_pseudo_em, file = "3e.pseudobulk_linneages_deconvolution/pseudo_sc.rds")
saveRDS(decon, file = "3e.pseudobulk_linneages_deconvolution/pseudo_decon.rds")
...
# save
saveRDS(liver_st,"liver_integrated_light_psudo_decon_linneages.rds")
...
png("3e.pseudobulk_linneages_deconvolution/Light_Pseudo_Decon.png", height = 4000, width = 5000)
print(plot)
dev.off()
...
# Plot UMAP
plot = FeaturePlot(liver_st, reduction = "umap", features = names(fractions), ncol=3)
png("3e.pseudobulk_linneages_deconvolution/Light_Pseudo_Decon_UMAP.png", height = 1500, width = 2000)
print(plot)
dev.off()
